...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.martiarch.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".matriarch" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".matriarch")
	}
