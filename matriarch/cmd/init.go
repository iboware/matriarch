...
var initCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err := utils.DownloadFile("https://github.com/iboware/postgresql-operator/releases/download/v0.4.0/postgresql-operator.crd.yaml", "/var/tmp/postgresql-operator.crd.yaml")
